...
<div class="container-fluid">
	<div class="row">
		<div class=" col-md-12 header">Cybage Training Project
	...
	<div id="link" class="row">
	  ...
	  <div class="col-xs-10 col-md-10">
	  	<div class="row">
	  		<div class="col-md-2">
	  			<a href="#ManageRelease" class="btn btn-primary col-xs-20 col-md-12">
	   				<span class="glyphicon glyphicon-share-alt" data-aria-hidden="true"></span>&nbsp;&nbsp;New Release
				</a>
	  		</div>
	  		<div class="col-md-2">

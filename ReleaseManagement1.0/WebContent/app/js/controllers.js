													...
													.addRelease(
															...
															function(response) {
																...
																if (response.status === 400
																	...
																	$scope.releases = "404 BAD REQUEST ...... Please Enter The Currect Details";
																}
															}
									...
									.showAllIteration(
											...
											function(response) {
												...
												if (response.status === 400) {
													...
													$scope.iterations = "404 BAD REQUEST ...... Please Enter The Currect Details";
												}
											});
		...
		.controller(
				...
				[
...

						{
							...
							$scope.by_date1 = function() {

								if (($scope.f1 === 0 & ($scope.f2 === 0
										| $scope.f3 === 0 | $scope.f4 === 0))
										| ($scope.f1 === 0 & ($scope.f2 === 1
												| $scope.f3 === 1 | $scope.f4 === 1))) {
									$scope.button_type = "date";

									/*alert($scope.button_type);
									alert("before me");
									alert($compile); */
									$scope.a = undefined;
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><input type='date' ng-model='a.date' class='form-control' placeholder='date'  /></div>")
															($scope));
									$scope.search_by = $scope.dateme;
									/* alert("sddsf00");*/

									$scope.f1 = 1;
								}
								if ($scope.f1 === 1
										& ($scope.f2 === 1 | $scope.f3 === 1 | $scope.f4 === 1)) {
									$scope.a = undefined;
									$scope.button_type = "date";
									$scope.yy = document
											.getElementById("third");
									$scope.yy.parentNode.removeChild($scope.yy);
									$scope.newme = document
											.createElement("div");
									$scope.newme.id = "third";
									$scope.secondme = document
											.getElementById("second");
									$scope.secondme.appendChild($scope.newme);
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><input type='date' ng-model='a.date' class='form-control' placeholder='date' /></div>")
							...
							$scope.by_title1 = function() {
								if (($scope.f2 === 0 & ($scope.f1 === 1
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><input type='text' ng-model='a.title' class='form-control' placeholder='title'   /></div>")
															($scope));
							...
							$scope.by_status1 = function() {
								...
								if ($scope.f4 === 0
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><select ng-model='a.status' class='form-control' placeholder='status'><option value='SELECT STATUS'>select type</option><option value='Planned'>Planned</option><option value='Working'>Working</option><option value='Completed'>Completed</option>  </select></div>")
															($scope));
									/* alert("done");*/
									$scope.search_by = $scope.typeme;
									$scope.f4 = 1;
							...
							$("form").submit(function() {
								...
								/*$scope.searchrelease = function() 
										{
												if($scope.f1===0 & $scope.f2===0 & $scope.f3===0 & $scope.f4===0)		
									{	
											...
											alert($scope.typeme);
													...
													{*/
								/*release.searchRelease({searchType : $scope.button_type},{searchKey : $scope.typeme},{},function(result) {
				...
				[
...

						{
							...
							$scope.by_date1 = function() {
								...
								if (($scope.f1 === 0 & ($scope.f2 === 0
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><input type='date' ng-model='a.date' class='form-control'  /></div>")
															($scope));
									$scope.search_by = $scope.dateme;
									/*alert("sddsf00")*/;
									$scope.f1 = 1;
							...
							$scope.by_type1 = function() {
								if ($scope.f3 === 0
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><select ng-model='a.type' class='form-control'><option value='SELECT TYPE'>select_type</option><option value='QA'>QA</option><option value='DEV'>DEV</option><option value='Planning'>Planning</option><option value='Release'>Release</option><option value='Regression'>Regression</option><option value=''></option></select></div>")
															($scope));
									/* alert("done");*/
									$scope.search_by = $scope.typeme;
									$scope.f3 = 1;
							...
							$scope.by_status1 = function() {
								if ($scope.f4 === 0
									...
									$("#third")
											.append(
													$compile(
															"<div class='col-xs-12'><select ng-model='a.status' class='form-control'><option value='SELECT STATUS'>select type</option><option value='Planned'>Planned</option><option value='Working'>Working</option><option value='Completed'>Completed</option>  </select></div>")
															($scope));
									/*alert("done");*/
									$scope.search_by = $scope.typeme;
									$scope.f4 = 1;
							...
							$("form").submit(function() {
								...
								/*	             	$scope.searchiteration = function() 
								 {
								 if($scope.f1===0 & $scope.f2===0 & $scope.f3===0 & $scope.f4===0)		
								 {	
								 alert("please select search by");
								 ...
								 {
								 iteration.searchIteration({searchType : $scope.button_type},{searchKey : $scope.typeme},{},function(result) {
								 ...
								 if($scope.iterationsearch===undefined)
								 {
